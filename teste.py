...
class Interface():
    ...
    def Captura(self):
        ...
        label = Label(self.root, image=self.photo).grid(
            row = 1,
            column = 0,
            padx = 15,
            pady = 5,
    ...
    def Treinamento(self):
        ...
        base_treinamento = gerador_treinamento.flow_from_directory('arruda',
                                                                   target_size=(64, 64),
                                                                   batch_size=32,
                                                                   class_mode='binary')

        base_teste = gerador_treinamento.flow_from_directory('ilha',
                                                             target_size=(64, 64),
                                                             batch_size=32,
                                                             class_mode='binary')
